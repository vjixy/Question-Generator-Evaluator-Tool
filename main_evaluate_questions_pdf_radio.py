...
if texts:
    ...
    for selected_model in selected_models:
        ...
        def vote(current_index, selected_model):
            st.session_state.feedback[current_index][selected_model] = st.session_state["rating_"+selected_model]
            database_service.update_rating(user_name, st.session_state.current_file, st.session_state.current_index, st.session_state["rating_"+selected_model], st.session_state.questions[current_index][selected_model], selected_model)
